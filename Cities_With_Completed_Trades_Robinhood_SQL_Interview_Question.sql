'''
his is the same question as problem #2 in the SQL Chapter of Ace the Data Science Interview!

Assume youre given the tables containing completed trade orders and user details in a Robinhood trading system.
